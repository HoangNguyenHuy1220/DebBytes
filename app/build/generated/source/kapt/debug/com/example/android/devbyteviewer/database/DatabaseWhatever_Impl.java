...
public final class DatabaseWhatever_Impl extends DatabaseWhatever {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `database_video` (`url` TEXT NOT NULL, `updated` TEXT NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `thumbnail` TEXT NOT NULL, PRIMARY KEY(`url`))");
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoDatabaseVideo.equals(_existingDatabaseVideo)) {
          return new RoomOpenHelper.ValidationResult(false, "database_video(com.example.android.devbyteviewer.database.DatabaseVideo).\n"
                  + " Expected:\n" + _infoDatabaseVideo + "\n"
                  + " Found:\n" + _existingDatabaseVideo);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "c8944133e4b0385a93e0e47f59560ec4", "2afb52a5bd0e84d22f54a7d48f4874fa");
